...
const DEFAULT_DARK_COLOR = "#22d3ee";
const DEFAULT_LIGHT_COLOR = "#0284c7";
...
function hexToRgb(hexColor: string) {
  try {
    ...
    console.error(
      `Invalid hex color '${hexColor}'.\nFalling back to default dark color '${DEFAULT_DARK_COLOR}'.`,
    );
  }

  return hexToRgb(DEFAULT_DARK_COLOR);
}
...
function AuraShader({
  ...
  const rgbColor = useMemo(() => hexToRgb(resolvedColor), [resolvedColor]);
